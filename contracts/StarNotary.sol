...
contract StarNotary is ERC721 {
    ...
    string public constant name = "NA_STAR_COIN";
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string public constant symbol = "NA_STAR";
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        if (owner != msg.sender) {
            revert("The sender is not the owner of the token");
        }

        require(
            owner == msg.sender,
            "You can't transfer a star if you don't own it"
        );
